 ...
 * 
 * Tuto třídu bohužel nedokážu opravit, nabízení třídy jetty neodpovídají použitým
 * např. HttpConfiguration, ServerConnector.
 * Je zavedena kvůli možnosti spustit aplikaci přímmo v jetty serveru, který je 
 * součástí aplikace.
 */
public class Start
{
